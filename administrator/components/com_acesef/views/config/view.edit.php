...
class AcesefViewConfig extends AcesefView {
	...
	function edit($tpl = null) {		
		...
		$this->toolbar->appendButton('Popup', 'purgeupdate', JText::_('ACESEF_COMMON_PURGEUPDATE'), 'index.php?option=com_acesef&amp;controller=purgeupdate&amp;task=view&amp;tmpl=component', 470, 280);
