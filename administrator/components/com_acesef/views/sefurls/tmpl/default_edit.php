		...
		<fieldset class="adminform">
			<table class="toolbar1">
				<tr>
					...
					<td class="divider"></td>
					<td>
						<a href="#" onclick="javascript: submitbutton('editSaveMoved'); submitbutton(); window.top.setTimeout('window.parent.document.getElementById(\'sbox-window\').close();', 1000);" class="toolbar"><span class="icon-32-save1" title="<?php echo JText::_('Save & Moved'); ?>"></span><?php echo JText::_('Save & Moved'); ?></a>
					</td>
					<?php }	?>
				</tr>
			</table>
