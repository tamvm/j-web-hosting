			...
			<th>		
				<?php
					...
					if (AcesefUtility::JoomFishInstalled()) {
						$jf_id = AceDatabase::loadResult("SELECT id FROM #__plugins WHERE element = 'jfrouter' AND published = '1'");
						if (!is_null($jf_id)) {
					...
					<tr>
						<td>
							...
							if ($this->AcesefConfig->ui_cpanel == 1) {
								...
								$this->acesefButton($link, 'icon-48-purgeupdate.png', JText::_('ACESEF_COMMON_PURGEUPDATE'), true, 470, 280);
						...
						<td valign="top" width="50%" align="center">
							<table class="adminlist">
								...
								<tr height="40">
									...
									<td>
										<a href="http://www.joomace.net" target="_blank"><?php echo AcesefUtility::getXmlText(JPATH_ACESEF_ADMIN.DS.'acesef.xml', 'copyright'); ?></a>
									</td>
								</tr>
								<tr height="40">
									<td>
