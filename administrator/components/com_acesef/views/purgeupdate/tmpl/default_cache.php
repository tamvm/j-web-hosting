...
<form action="index.php?option=com_acesef&amp;controller=purgeupdate&amp;task=cache&amp;tmpl=component" name="adminForm" method="post">
	<fieldset class="adminform">
		...
		<input type="submit" class="button" name="cleancache" onclick="window.top.setTimeout('window.parent.document.getElementById(\'sbox-window\').close();', 1500);" value="<?php echo JText::_('ACESEF_CACHE_CLEAN'); ?>" />
	</fieldset>
