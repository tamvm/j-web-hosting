...
function show_pop() {
document.getElementById("popup_div").style.top = '-200px';
document.getElementById("popup_div").style.display = 'block';
s5_box_drop();
}

function s5_box_drop_call() {
s5_box_drop();
}

var s5_sb_box_top = -200;

function s5_box_drop() {
if (s5_sb_box_top < 175){
document.getElementById("popup_div").style.top = s5_sb_box_top + "px";
window.setTimeout('s5_box_drop_call()',10);
s5_sb_box_top = s5_sb_box_top + 10;
}
else if (s5_sb_box_top >= 175){
s5_sb_box_top = -200;
}
}
